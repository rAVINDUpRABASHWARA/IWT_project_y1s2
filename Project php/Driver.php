...
<hr class="hr">
    ...
    <section style="background-image: url(Images/supback.jpg);">
        ...
        <ul class="left">
            ...
            <li><a class="active" href="Delivery_details.php">Delivery Details</a></li>
            <li><a class="active" href="Driver_details.php">Driver Details</a></li>
            <li><a class="active" href="driverUDE.php">Update Driver Details</a></li>
        </ul>



        <center>
            <h1 class="welcome">WELCOME <br> TO <br> FRANDY <br> MUSIC INSTRUMENT STORE <br><br>DRIVER MANAGEMENT PAGE</h1>
        </center>
