...
<body bgcolor="#3FEEE6">
	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<table align="center" width="795"  bgcolor="#6A8A82" height="700";>
...
$update_product="update products set product_cat='$product_cat', product_brand = '$product_brand', product_title='$product_title' , product_price='$product_price' ,
 product_desc='$product_desc' , product_image='$product_image', product_keywords='$product_keywords' where product_id='$update_id' ";
...
if ($run_product) {
	...
	echo"<script>window.open('Manager.php?view_products.php','_self')</script>";
}
