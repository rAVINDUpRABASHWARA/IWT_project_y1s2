...
<hr class="hr">
	...
	<section>
        <ul class="left">
            <li><a class="active" href="orderFM.php">Order Details</a></li>
            <li><a class="active" href="productFM.php">Product Details</a></li>
            <li><a class="active" href="customerFM.php">Customer Details</a></li>
            <li><a class="active" href="deliveryFM.php">Delivery Details</a></li>
